<template>
  <header
    id="header"
    class="header flex flex-row justify-between md:justify-end items-center md:items-start sticky md:absolute top-0 m:t-0 z-50 w-full py-3 px-6 md:p-8 bg-white md:bg-transparent border border-b-1 border-gray-400 md:border-0"
    role="banner"
  >
    <svg
      class="md:hidden w-16"
    ...
    <div class="flex items-center">
      ...
      <a href="https://adamrobertson.medium.com/" target="_blank" class="hidden md:inline hover:text-black">
        <svg
          class="h-5 mr-5 fill-current"
          xmlns="http://www.w3.org/2000/svg"
          width="24"
      ...
      >
        <svg
          class="hidden md:block fill-current h-4 mr-1"
          xmlns="http://www.w3.org/2000/svg"
          width="24"
          height="24"
          viewBox="0 0 24 24"
